...
Burials were assigned to pre-European contact period, post-European contact period, and Chinese period based on the stratigraphic data, radiocarbon dates, and diagnostic porcelain such as white-glazed jars as a time indicator of the arrival of the Europeans[citation]. The burials that were disturbed severely due to modern construction are excluded due to incomplete data. Since the accumulation of imported prestige goods in burials is commonly observed, we assign the burials into four classes, high, medium, low, and none, accoutring to the total number of burial goods to indicate the index of wealth. 
