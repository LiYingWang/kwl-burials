...
ft <- flextable(posterior_esti_two_phases) %>% 
  ...
  set_caption("Estimated posterior means, standard deviation, medians, and 95% credible intervals for the pre-Euroepan model.") 
ft
```
...
```{r figure-distribution-moments, fig.cap = "Distribution moments (mean, skewness, variance) calculated on the observed data and simulated distributions for the pre- and post- European models."}
