...
Archaeological sites in northeastern Taiwan show the evidence of accumulation patterns of imported goods, such as ornaments and porcelains, in residential areas and burial contexts around the same time as European contacts in the 17th century [@Chen2007; @LWandBM2020ornament]. Imported goods were treated as prestige or wealth in those Indigenous societies that were commonly mentioned in Spanish historical records in the 17th century (1624-1642) [@Borao2009; @LiandWu2006]. For example, a document written by a Spanish priest described a Spanish soldier using carnelian beads to exchange for natural resources with local Indigenous people, because of their high value in Indigenous culture [@LiandWu2006]. In addition, Spanish visitors observed that an Indigenous person possessing more imported goods may have been recognized as more influential or having higher status in their community [@LiandWu2006]. Despite the fact that we recorded an uneven distribution of imported goods in burials, the degree of differentiation across burials over time remained unclear. The introduction of foreign prestige goods to local Indigenous communities might have occurred before European presence became established, but was maintained and amplified after European arrival due to local competition for power [@Borao2009; @LiandWu2006; @LWandBM2020ornament; @Ueda2016]. A general model to summarize this situation in northeastern Taiwan might assume that the influence of a colonial power, combined with high local values attached to imported goods, might lead to increased social inequality due to competition among individuals [@Brumfiel1994; @Clark1994]. The observed uneven distribution in Northeastern Taiwan may be explained as a result of unequal access to trade goods when Indigenous societies became more involved in the complex trade network stimulated by Europeans. 

<!-- archaeological specific case study -->
In what follows, we explore social changes in a pericolonial context at Kiwulan (Figure \@ref(fig:figure-KWL-map)), an Iron Age site in northeastern Taiwan, which was occupied from 14th to 19th centuries. This occupation period includes the time before the European arrival, the presence of the Europeans, including the Spanish and the Dutch, in the 17th century, and finally a large wave of Han Chinese in the 19th century [@Chen2007]. We argue that the involvement in the long-distance trade stimulated by the Europeans might lead to increased social inequality at Kiwulan. This argument would be supported by changes in the structure of networks built on burial data based on the assumption that burials can reflect social structure. We examine burial networks before and after the foreign contacts, and test our hypothesis that increased social inequality can be observed in the network after the European arrival in 17th century Taiwan. We ask: (1) did European colonial activities result in increased social inequality in Indigenous society in ways that can be detected by analysis of burial networks? (2) what are the major variables affecting or forming the unequal social positions represented by higher degree of network popularity (e.g., a few nodes have more relationships with other nodes) that might hint at social heterogeneity influence by the European arrival? By answering these questions, this case study helps to expand our understanding of European colonial effects on Indigenous groups in an indirect way by examining burial data. We also introduces a novel Bayesian approach on statistical modeling for networks that is suitable for networks with smaller sizes. 
