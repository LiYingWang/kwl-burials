...
Burials analysis has long developed in archaeology as an approach to study past social structure through mortuary practices, such as cultural and biological records in burial contexts, that can represent social status or identity of the deceased [@Binford1971; @Saxe1970]. Despite the criticism for overlooking the burial manipulation by the living that does not necessarily connect to the real life [@Hodder1980; @Pearson1982], with comparisons between different archaeological contexts of death and life in mind, burials can still provide valuable information to infer past societies [@Chapman2003]. For example, mortuary practices, including burial forms, grave goods, and ritual behaviors, that structure the material configuration of burials can represent social relations between members of a community, allowing the inference for social structures [@Byrd1995; @Seikel2011]. To study social relations, the recent development of network science and graph theory provides many new tools for the exploration and analyzing the structure of relational data [@Brandes2013]. This means we can answer anthropological questions about social differentiation, and social inequality or complexity based on our assumptions of archaeological data [@Ehrhardt2009; @Gamble2002; @Janes2013; @Johansen2015]. For example, burial goods can reflect social practices in broader cultural contexts to represent personal wealth, social roles, or traditional customs. The flow of material goods  Burials with the same goods may indicate some similar underlying social relations where individuals share similar access to trade, exchange, and gifting networks [eg. @Coward2013, pp. 252]. Identifying the structure of relationships among burials can give insights into the structure of social organization. 
