...
highlights: |
  ...
  2. We test social processes by simulating two sets of burial data from different time.
  3. Differences in network statistics implies changes in social structures influenced by foreign presence. 
  4. Bayesian ERGMs is efficient and useful for evaluating and interpreting networks. 
---
