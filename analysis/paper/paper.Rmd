...
Bayesian approach to ERGMs is an efficient computational tool for social network analysis because it incorporates prior information about the network effects into the model and offers uncertainty quantification by evaluating the posterior distribution of the parameters associated with the network effects [@Caimo2015; @Nemmers2019]. This provides better estimations for complex social network models with heterogeneous data [@Caimo2017]. 

# Methods

We use burial data from different time periods at Kiwulan and consider the effects of both exogenous and endogenous factors that may provide meaningful explanation of the tendency of burials correlate with each other and the underlying mechnism. 

n concerning connectivity, inter-cultural contacts and exchange among those sites. Our purpose is to understand the characteristics of burial network and the mechanism of the relationship influence on the pattern of accumulation of wealth during different foreign contact periods. Previous studies have shown that there are some evidence of social inequality observed from Kiwulan but the degree over time and causes remain unclear. To answer our question for the shifts in social inequality during and after the arrival of the foreign presences, we hypothesize: 
