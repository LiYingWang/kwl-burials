...
```{r bergm-pre, include=FALSE}
suppressWarnings(source(here::here("analysis", "code", "003-burials-pre-network-modelling.R")))
```

```{r bergm-post, include=FALSE}
suppressWarnings(source(here::here("analysis", "code", "004-burials-post-network-modelling.R")))
```
...
```{r bootstrap-CI-test, include=FALSE, cache=TRUE, cache.extra=tools::md5sum(here::here("analysis/code/007-bootstrap-CI.R"))}
suppressWarnings(source(here::here("analysis", "code", "007-bootstrap-CI.R")))
```
