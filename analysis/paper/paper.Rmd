...
```{r site-map, figure-KWL-map, fig.cap = "The location of Kiwulan and other places with the European forts in northern Taiwan mentioned in the text (map modified from Wang and Marwick, 2020). Map data from naturalearthdata.com."}
