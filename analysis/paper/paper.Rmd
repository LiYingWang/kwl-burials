...
We compared estimated statistics from the posterior distributions, networks before and after the European presence, to examine their differences in network structure. For the earlier network, the covariates having significant tendency to form relations between burials includes age-homophily and ritual-homophily. The age homophiligy shows negative effect that that indicates burials with the same age does not share similar prestige goods, but different age does instead. The positive value of ritual-homophily shows burial with riutal pottery also to form relations. Despite other covariates are positive such as sex and burial values, they does not show significant tendency to form relationships. 
