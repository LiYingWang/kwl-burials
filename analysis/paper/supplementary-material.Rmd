...
```{r explore-data, include=FALSE, cache=TRUE, cache.extra=tools::md5sum(here::here("analysis/paper/000-prep2-goods-class-plot.R"))}
suppressWarnings(source(here::here("analysis", "paper", "000-prep2-goods-class-plot.R")))
```
...
# combine ridge plots 1 & 4 in the 000-prep2 file
library(tidyverse)
library(ggridges)
ridge_1_and_4 <-
  burial_beads %>%
...
png(filename = here::here("analysis", "figures", "008-pre-diag.png"),
    width = 10, height = 8, units = "in", res = 360)
plot(pre_bergm)
dev.off()
```
...
p1 <- ~{plot(pre_bergm)}
plot_grid(p1)
ggsave(here::here("analysis", "figures", "009-pre-diag.png"),
