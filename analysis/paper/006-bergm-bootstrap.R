...
pre_bootdd <- boot_dd(pre_empdd,
                      50)# number of bootstrap sample for non-seed vertex
...
post_CIvertboot_star <- quantile(pre_boot_star , c(0.025, 0.975))
...
post_bootdd <- boot_dd(post_empdd,
                       100)# number of bootstrap sample for non-seed vertex
